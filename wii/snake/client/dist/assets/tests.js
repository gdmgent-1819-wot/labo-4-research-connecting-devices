...
define('client/tests/helpers/destroy-firebase-apps', ['exports', 'firebase'], function (exports, _firebase) {
  'use strict';
...
define('client/tests/lint/app.lint-test', [], function () {
  ...
  QUnit.test('components/comp-highscores.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/comp-highscores.js should pass ESLint\n\n');
  });

  QUnit.test('models/score.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'models/score.js should pass ESLint\n\n');
  });
...
define('client/tests/lint/templates.template.lint-test', [], function () {
  ...
  QUnit.test('client/templates/highscores.hbs', function (assert) {
    assert.expect(1);
    assert.ok(false, 'client/templates/highscores.hbs should pass TemplateLint.\n\nclient/templates/highscores.hbs\n  2:4  error  Incorrect indentation for `<table>` beginning at L2:C4. Expected `<table>` to be at an indentation of 2 but was found at 4.  block-indentation\n  3:8  error  Incorrect indentation for `<tbody>` beginning at L3:C8. Expected `<tbody>` to be at an indentation of 6 but was found at 8.  block-indentation\n  10:8  error  Incorrect indentation for `<tbody>` beginning at L10:C8. Expected `<tbody>` to be at an indentation of 6 but was found at 8.  block-indentation\n  4:12  error  Incorrect indentation for `<tr>` beginning at L4:C12. Expected `<tr>` to be at an indentation of 10 but was found at 12.  block-indentation\n  5:16  error  Incorrect indentation for `<th>` beginning at L5:C16. Expected `<th>` to be at an indentation of 14 but was found at 16.  block-indentation\n  5:32  error  Incorrect indentation for `\n                    SnakePy Highscores\n                ` beginning at L5:C32. Expected `\n                    SnakePy Highscores\n                ` to be at an indentation of 18 but was found at 20.  block-indentation\n  11:12  error  Incorrect indentation for `{{#each}}` beginning at L11:C12. Expected `{{#each}}` to be at an indentation of 10 but was found at 12.  block-indentation\n  12:12  error  Incorrect indentation for `<tr>` beginning at L12:C12. Expected `<tr>` to be at an indentation of 14 but was found at 12.  block-indentation\n  13:16  error  Incorrect indentation for `<td>` beginning at L13:C16. Expected `<td>` to be at an indentation of 14 but was found at 16.  block-indentation\n  14:16  error  Incorrect indentation for `<td>` beginning at L14:C16. Expected `<td>` to be at an indentation of 14 but was found at 16.  block-indentation\n');
  });
});
...
define('client/tests/unit/routes/highscores-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
