...
;define('client/adapters/application', ['exports', 'emberfire/adapters/firebase'], function (exports, _firebase) {
  'use strict';
...
;define('client/components/comp-highscores', ['exports'], function (exports) {
    'use strict';
...
;define('client/initializers/emberfire', ['exports', 'emberfire/initializers/emberfire'], function (exports, _emberfire) {
  'use strict';
...
;define('client/models/score', ['exports', 'ember-data'], function (exports, _emberData) {
  'use strict';
...
;define('client/routes/highscores', ['exports'], function (exports) {
    'use strict';
...
;define('client/services/firebase-app', ['exports', 'emberfire/services/firebase-app'], function (exports, _firebaseApp) {
  'use strict';
...
;define('client/services/firebase', ['exports', 'emberfire/services/firebase'], function (exports, _firebase) {
  'use strict';
...
;define("client/templates/application", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "ePqqEYcB", "block": "{\"symbols\":[],\"statements\":[[1,[21,\"outlet\"],false]],\"hasEval\":false}", "meta": { "moduleName": "client/templates/application.hbs" } });
});
;define("client/templates/highscores", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "ENVyvQEq", "block": "{\"symbols\":[\"score\"],\"statements\":[[7,\"div\"],[11,\"class\",\"container\"],[9],[0,\"\\n    \"],[7,\"table\"],[11,\"class\",\"table\"],[9],[0,\"\\n        \"],[7,\"tbody\"],[9],[0,\"\\n            \"],[7,\"tr\"],[9],[0,\"\\n                \"],[7,\"th\"],[11,\"colspan\",\"2\"],[9],[0,\"\\n                    SnakePy Highscores\\n                \"],[10],[0,\"\\n            \"],[10],[0,\"\\n        \"],[10],[0,\"\\n        \"],[7,\"tbody\"],[11,\"class\",\"resultsTable\"],[9],[0,\"\\n\"],[4,\"each\",[[23,[\"model\"]]],null,{\"statements\":[[0,\"            \"],[7,\"tr\"],[9],[0,\"\\n                \"],[7,\"td\"],[9],[7,\"i\"],[11,\"class\",\"fa fa-star\"],[11,\"aria-hidden\",\"true\"],[9],[10],[1,[22,1,[\"name\"]],false],[10],[0,\"\\n                \"],[7,\"td\"],[9],[1,[22,1,[\"score\"]],false],[10],[0,\"\\n            \"],[10],[0,\"\\n\"]],\"parameters\":[1]},null],[0,\"        \"],[10],[0,\"\\n    \"],[10],[0,\"\\n\"],[10]],\"hasEval\":false}", "meta": { "moduleName": "client/templates/highscores.hbs" } });
});
...
;
          if (!runningTests) {
            require("client/app")["default"].create({"name":"client","version":"0.0.0+ea962061"});
          }
